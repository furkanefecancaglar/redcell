...
| 4 | **Runtime input firewall** `/firewall` | Inspects every untrusted input in production and blocks injection/exfil/jailbreak in ~15us of compute, ~3ms added over a static response — 38 detectors (33 pattern rules + hidden-character / unicode-tag / obfuscated-injection / bidi-injection signals) plus base64/leetspeak/homoglyph/zero-width deobfuscation, 0 FP/FN on the test corpus | every request |
