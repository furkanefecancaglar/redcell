...
3/ It also firewalls the input (75 detectors + deobfuscation: base64/leetspeak/homoglyph/zero-width/bidi/invisible-unicode, + optional semantic for paraphrases) and scores your system prompt (22 checks + a hardened-prompt kit).
